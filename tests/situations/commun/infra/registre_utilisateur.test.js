...
describe('le registre utilisateur', function () {
  ...
  describe('#connexionParCodeBeneficiaire()', function () {
    it('permet de connecter un utilisateur avec code_beneficiaire', function () {
      ...
      return registre.connexionParCodeBeneficiaire('ABC123').then((resultat) => {
    ...
    it('remonte une erreur code_beneficiaire_inconnu en cas de 404', function () {
      ...
      return registre.connexionParCodeBeneficiaire('UNKNOWN').catch((erreur) => {
        expect(erreur.message).toEqual('code_beneficiaire_inconnu');
      });
    });
    ...
    it('remonte une erreur erreur_reseau en cas de status 0', function () {
      ...
      return registre.connexionParCodeBeneficiaire('DISCONNECTED').catch((erreur) => {
    ...
    it("remonte l'objet d'erreur brut pour d'autres statuts", function () {
      ...
      return registre.connexionParCodeBeneficiaire('BUG').catch((erreur) => {
