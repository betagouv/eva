...
import CetC1 from 'livraison/assets/illustration_questions/CetC1.jpg';

describe('Le dépot ressource de la situation Livraison', function () {
  let depot;

  beforeEach(function () {
    depot = new DepotRessourcesLivraison(chargeurs());
  });
