<template>
  <svg height="100%" width="100%">
    ...
    >
      ...
      >
        <svg width="64" height="64" viewBox="0 0 64 64" x="37%" y="78%" class="overlay-zone-action">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M26 51C40.3594 51 52 39.5833 52 25.5C52 11.4167 40.3594 0 26 0C11.6406 0 0 11.4167 0 25.5C0 39.5833 11.6406 51 26 51ZM41.5416 14.3955C42.2484 13.5092 42.124 12.2004 41.2637 11.4722C40.4034 10.744 39.1331 10.8722 38.4263 11.7585L21.3023 33.2316L17.6413 28.0931C16.9825 27.1684 15.7208 26.969 14.8232 27.6478C13.9257 28.3265 13.7321 29.6264 14.391 30.5511L21.123 40L41.5416 14.3955Z" fill="#9ADBD0" transform="translate(7 7)" />
          <circle r="28" cx="32" cy="32" class="overlay-zone-action-hover" />
        </svg>

        <svg width="64" height="64" x="47%" y="78%" class="overlay-zone-action">
