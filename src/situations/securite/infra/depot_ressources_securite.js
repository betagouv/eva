...
import sonTransition from 'securite/assets/consigne_transition.wav';
...
export default class DepotRessourcesSecurite extends DepotRessourcesCommunes {
  constructor (chargeurs) {
    ...
    this.charge([fondSituation, fondSituationEntrainement, pictoDangerBienIdentifie, pictoDangerMalIdentifie, sonTransition]);
  }
  ...
  messageTransition () {
    return this.ressource(sonTransition);
  }
}
